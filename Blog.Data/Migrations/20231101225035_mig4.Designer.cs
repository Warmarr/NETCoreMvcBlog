            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "4410006b-a872-4d91-9213-d305468b76b0",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "8c8b163d-7b34-447a-93f7-f4ad8989baa8",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f9f8bf47-dac2-4242-8ce4-1d538ff57947",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a29d886a-7604-484f-91a4-545124a68d36"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "269bcdd6-0073-4bcc-902e-761bf918d154",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECZW67RdQ0ATbX3NS3uijp5uS29U3FZMkFRVkdUeXKL2by98Z1UL/dtqMqS68/sr2w==",
                            PhoneNumber = "+905439999999",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "68ce94af-8593-4302-a229-f04f20d001e9",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ffdadad6-d578-4bff-9386-6e54927e4b61",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFr48VT9yA4HAGf8MR4Yk/07gE8rsXyErD1UTwB60bGdwJC/8jM0cx0QriMAZJH02Q==",
                            PhoneNumber = "+905439999988",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "872a390a-cbdd-44ad-b903-29085a34ad29",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0e0de4f5-f2b7-484a-af6e-66eece42696b"),
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 11, 2, 1, 50, 34, 930, DateTimeKind.Local).AddTicks(2971),
                            ImageId = new Guid("eed85427-ca26-4cf3-8932-1fc664b72dfe"),
                            IsDeleted = false,
                            Title = "C# Windows Forms",
                            UserId = new Guid("a29d886a-7604-484f-91a4-545124a68d36"),
                            WievCount = 15
                        },
                        new
                        {
                            Id = new Guid("3e9588ed-5067-4e69-b0f3-390457d4e547"),
                            CategoryId = new Guid("87881e74-d118-48e4-8e1e-f05441ed12c2"),
                            Content = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 11, 2, 1, 50, 34, 930, DateTimeKind.Local).AddTicks(2980),
                            ImageId = new Guid("f5083e18-2cb7-46f9-b7e0-89a11cacdcea"),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 11, 2, 1, 50, 34, 930, DateTimeKind.Local).AddTicks(3184),
                            IsDeleted = false,
                            Name = "Asp.NET"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 11, 2, 1, 50, 34, 930, DateTimeKind.Local).AddTicks(3189),
                            IsDeleted = false,
                            Name = "C#"
                        });
                });
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 11, 2, 1, 50, 34, 930, DateTimeKind.Local).AddTicks(3309),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2023, 11, 2, 1, 50, 34, 930, DateTimeKind.Local).AddTicks(3315),
